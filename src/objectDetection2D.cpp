                   ...
                   std::string modelWeights, bool bVis)
{
    ...
    vector<int> outLayers = net.getUnconnectedOutLayers(); // get  indices of  output layers, i.e.
    ...
    if (bVis)
    {
        ...
        for (auto it = bBoxes.begin(); it != bBoxes.end(); ++it)
        {
            ...
            cv::rectangle(visImg, cv::Point(left, top), cv::Point(left + width, top + height), cv::Scalar(0, 255, 0),
                          2);
